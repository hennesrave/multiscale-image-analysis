...
private:
    ...
    void import_spectra();
    void compute_similarity_dataset( const std::vector<ImportedSpectrum>& spectra ) const;
    void compute_similarity_segments( const std::vector<ImportedSpectrum>& spectra ) const;
